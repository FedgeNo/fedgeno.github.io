...
| ρ meson from comb filter (OQ35) | Im[Γ₃₄₆] maximum at 775.794 MeV (+0.069% vs PDG 775.260 MeV). Inputs: g₃₃=8√7, g₄₄=12/√7, g₆₆=1/4, τ_d=1/(2√(k₀+d)) at k₀=16. No mass input. The +0.069% residual is a genuine prediction floor: WKB correction to τ_d for d=3 goes in the wrong direction, and is zero for d=10 by the Gegenbauer criticality theorem. |
