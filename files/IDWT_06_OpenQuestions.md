...
Three open items: (a) φ(ss̄): the strange quark sits at the regime boundary — neither formula works at leading order; (b) J/ψ residual (+2.0%): small correction to the heavy formula for cc̄; (c) baryon octet Λ, Σ, Ξ, Ω: the proton formula works but extending to strange-containing baryons shows ~15% systematic underestimate, suggesting an additive mass contribution per strange quark not yet derived.
