...
|--------|----------|------------|-------|---------|
| $d=2$ | $\mathbb{CP}^1$ | 1 | C(2,1) = 2 | 2 gauge polarizations (photon/W±); gauge sector — index counts polarizations, not fermionic zero modes |
