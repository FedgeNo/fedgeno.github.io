...
The d=5 coupling is algebraically closed: g₅₅ = 96/g₂₂ = 0.1329. But naive Route B gives m_scale_5 ≈ 0.37 MeV, implying a lightest neutrino mass of ~746 MeV — off from the observed ~1.5 meV by a factor of ~5×10¹¹. This is the IDWT form of the neutrino mass hierarchy problem. Neutrino mass RATIOS are fully predicted (S(10,5):S(15,5):S(22,5)). The absolute mass scale (anchored to Δm²₂₁ = 7.53×10⁻⁵ eV²) requires a suppression mechanism: non-perturbative Stage-1 suppression at λ̂₅ ≫ 1, a seesaw-like mechanism within S⁵ geometry, or a condensate scale arising from the (5,5)→10 Vandermonde vertex. g₅₅ algebra is closed; mass scale mechanism is open.
