...
**On m_ν₁, m_ν₂ and the solar splitting.** The predicted Δm²₂₁ = (m_ν₂² − m_ν₁²) = (8.639² − 1.487²) × 10⁻⁶ eV² = 7.242 × 10⁻⁵ eV² lies 2.4% below the PDG 2023 central value of 7.42 × 10⁻⁵ eV² (uncertainty ±0.20 × 10⁻⁵), a discrepancy of −0.89σ. Unlike the Δm²₃₁ case, no structural correction analogous to δ_ν₃ is available: n_ν₁ = S(n_u,3) and n_ν₂ = S(n_u,4) are primary Pascal evaluations at the seed with no cross-sector entanglement, so there is no inclusion-exclusion residual to correct. The mode indices are exact; the discrepancy resides entirely in the overall scale m_scale_5, which is fixed by the cross-sector equation and admits no free parameter. At present this is a sub-1σ tension, within experimental uncertainty, but it is not explained away. It is recorded here as a genuine open question: whether a first-principles mechanism shifts the solar splitting by ~2.4% without disturbing Δm²₃₁, or whether the PDG central value moves as reactor and solar constraints are refined (historically Δm²₂₁ has shown tension between KamLAND and solar analyses at the ~2% level).
