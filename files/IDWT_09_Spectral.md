...
The 15 elements of $\sigma_{\rm phys}(|D|)$ are exactly the SM particle masses. Every element is determined by seeds $\{n_d=1,\,n_u=3\}$ (composite $n_s=4$) and the single mass unit $m_e$.
