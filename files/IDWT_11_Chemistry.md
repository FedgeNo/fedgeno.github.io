...
- **Ontology and falsifier.** The $\mathbb{CP}^3$-hidden orbit states exist at every shell $L \geq 1$ and are strictly inaccessible to 3D apparatus at any order (Part 8 §14.3, Lemma 2). Standard QM has no counterpart states. Any measured coupling to one falsifies the $d=6$ sector identification — a standing, permanent discriminator.
